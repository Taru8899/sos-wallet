 ...
 *   oldest entries are overwritten / erased in strict order. This completely
 *   eliminates the previous unbounded-array growth issue.
...
contract PresenceLogger {
    ...
    function _eraseOldest(address erasedBy) internal {
        ...
        // Clear the slot (optional but keeps the buffer clean)
     ...
     * @return live Live count (identical to the public state variable).
     */
